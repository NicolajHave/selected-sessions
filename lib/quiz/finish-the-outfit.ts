...
export const FINISH_THE_OUTFIT: Record<number, FtoEntry> = {
  100: {
    ...
    lyricTimings: [10, 16, 18.9, 25.9, 30.5, 36.5, 41.5, 45.5, 49],
    maskedAnswer: "---'- ------' --- - ---------",
  ...
  200: {
    ...
    lyricTimings: [
      5, 8, 11, 13, 15, 17, 19, 24, 28, 33, 36, 39, 41, 43, 45, 49, 53.5, 57, 62,
      64, 67, 71, 74.6,
    ],
    maskedAnswer: "---- -'-- --- -------",
  ...
  300: {
    ...
    lyricTimings: [23.5, 26.5, 29.5, 34.5, 40.3, 42.5, 45.5, 48.7, 53.2, 55, 60, 65, 68],
    maskedAnswer: '--- ----- -- ------, ------',
  ...
  400: {
    ...
    lyricTimings: [8, 12, 16, 19, 23, 27, 30.5, 33, 37, 41, 44, 48, 53, 56, 60],
    maskedAnswer: '--- ---- ---- - ----- ---',
  ...
  500: {
    ...
    lyricTimings: [
      0, 2, 4, 6, 10, 13.5, 16.5, 22, 25, 28, 30, 32, 34, 41, 45, 50.5, 54, 58.5,
